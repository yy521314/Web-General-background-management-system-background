 ...
 * @Date: 2024-04-10 20:26:21
 * @LastEditors: 'yang' '1173278084@qq.com'
 * @LastEditTime: 2024-04-12 16:09:10
 * @FilePath: \Web-General-background-management-system-background\src\views\set\components\editor.vue
...
bus.on("editorTitle", async (id: number) => {
	...
	if (id == 2) {
		title.value = "编辑公司要求";
		valueHtml.value = await getCompanyIntroduce("公司要求");
	}
	if (id == 3) {
		title.value = "编辑公司战略";
